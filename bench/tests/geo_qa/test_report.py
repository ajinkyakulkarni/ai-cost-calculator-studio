"""Tests for geo_qa/report.py — report generator.
...
def test_cost_per_query_formula():
    ...
    from agent_cost_bench.geo_qa.report import (
        _cost_per_query,
        GPT52_INPUT_PER_M,
        GPT52_CACHED_PER_M,
        GPT52_OUTPUT_PER_M,
...
def test_cost_per_query_zero_tokens():
    ...
    from agent_cost_bench.geo_qa.report import _cost_per_query
...
def test_emit_report_uses_fixed_descriptive_filename(reports_dir):
    ...
    assert out.name == "geo-qa-templating-bench-report.md"
