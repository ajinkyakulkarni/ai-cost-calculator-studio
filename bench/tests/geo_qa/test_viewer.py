"""Tests for geo_qa/viewer.py — static HTML viewer generator.
...
def test_build_viewer_creates_html_file(reports_dir):
    from agent_cost_bench.geo_qa import viewer as vmod
...
def test_build_viewer_fixed_filename(reports_dir):
    ...
    assert out.name == "geo-qa-templating-viewer.html"
