...
from agent_cost_bench.geo_qa.handlers import FreeformHandler, KeyFieldsHandler
from agent_cost_bench.geo_qa.schemas import SearchItemsReturn, StacItemFields
...
def test_freeform_falls_back_to_model_dump_json_without_raw_response():
    ...
    from agent_cost_bench.geo_qa.schemas import ComputeStatsReturn
