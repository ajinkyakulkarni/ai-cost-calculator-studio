"""Pattern E — 5-gate drill-down with EIE-shaped conversation.
...
def build_pattern_e_graph(handler: Any, user_actor: UserActor, model: str = "gpt-5.2"):
    """Build the Pattern E LangGraph state machine."""
    g = StateGraph(State)
