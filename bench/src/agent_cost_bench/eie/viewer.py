"""Static HTML viewer for the eie-templating bench traces.
...
Usage::
    ...
    from agent_cost_bench.eie.viewer import build_viewer

    html_path = build_viewer()
    # Open bench/reports/eie-templating/eie-templating-viewer.html in a browser
"""
...
VIEWER_FILENAME = "eie-templating-viewer.html"
...
<body>
<div id="topbar">
  <h1>eie-templating bench viewer</h1>
...
def build_viewer() -> Path:
    ...
    -------
    Path
        Path to the written HTML file (bench/reports/eie-templating/eie-templating-viewer.html).
    """
