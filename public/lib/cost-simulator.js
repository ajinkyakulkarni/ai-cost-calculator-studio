...
/* UI MODE + AUDIENCE BLOCK — moved out 2026-06-10 (modularization pass):
   - lib/ui-mode.js        setUiMode() + boot init + hashchange resync
   - lib/audience-math.js  pure aggregate formulas (unit-tested in Node:
                           scripts/test-audience-math.js)
   - lib/audience-block.js DOM rendering + event wiring for the
                           "Your audience" panel
   Load order (index.html): cost-simulator.js -> audience-math.js ->
   ui-mode.js -> audience-block.js. The boot setTimeout below still
   calls renderAudienceBlock() via the global that audience-block.js
   defines. */
