...
(function (root) {
  ...
  const Prices = {
    ...
    llm_models: {
      ...
      // Anthropic explicit cache: writes cost 1.25× input, reads cost 0.10×.
      // cache_write_share_default ≈ 0.10 represents a typical refresh ratio
      // when system prompts cycle every 5min TTL on a steady multi-turn
